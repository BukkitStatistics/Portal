...
<div class="row">
    <div class="span6">
        ...
        <div class="control-group">
            <label class="control-label" for="adminemail"><?php echo fText::compose('Admin Email'); ?>:</label>

            <div class="controls">
                <input type="email" name="adminemail" id="adminemail" value="<?php echo $this->get('adminemail'); ?>">
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <input type="radio" name="time_format" id="time_format1" value="24" <?php fHTML::showChecked(24,
                                                                                                                $this->get('time_format')) ?>>
                    24 hour format: <?php echo date('H:i - d.m.Y') ?>
                </label>
                <label class="radio">
                    <input type="radio" name="time_format" id="time_format0" value="12" <?php fHTML::showChecked(12,
                                                                                                                $this->get('time_format')) ?>>
    ...
    <div class="span6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <label class="checkbox">
                    <input type="checkbox" name="welcome_msg" value="1" <?php fHTML::showChecked(1,
                                                                                                 $this->get('welcome_msg')) ?>>
                    Show welcome message.
                </label>
                <label class="checkbox">
                    <input type="checkbox" name="welcome_first_msg" value="1" <?php fHTML::showChecked(1,
                                                                                                       $this->get('welcome_first_msg')) ?>>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input class="span1" type="number" name="ping" id="ping" value="<?php echo $this->get('ping') ?>">
                <span class="help-block">
                    Time in seconds.
                    This value sets how often your server will update the database with values.
                </span>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="span12">
        <div class="form-actions">
            <button type="submit" name="general_submit" value="1"
