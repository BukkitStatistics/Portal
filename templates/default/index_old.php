    ...
    <div class="navbar-inner">
        <div class="container force-center">
            ...
            <ul class="nav pull-right">
                ...
                <?php if($login == "Guest") {
                echo '<li><a href="contents/default/login/">Log in</a></li>';
            }
            else { ?>

                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" id="dLabel" role="button" data-toggle="dropdwn"
                       data-target="#"><?php echo $login; ?><b class="caret"></b></a>
            ...
            <div class="span10 offset2">
                <div class="row-fluid">
                    ...
                    <div class="span4 offset2" style="text-align: right;"><p>Running database
                        version <?php echo ($sObj->getDatabaseVersion()); ?><br/>YASP-WEB v.<?php echo VERSION; ?></p>
                    </div>
                </div>
            </div>
        </div>
